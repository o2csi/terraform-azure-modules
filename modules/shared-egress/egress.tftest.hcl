...
run "one_router_rollout" {
  ...
  assert {
    condition     = azurerm_lb_rule.egress[0].protocol == "All" && azurerm_lb_rule.egress[0].frontend_port == 0 && azurerm_lb_probe.egress[0].protocol == "Http" && output.endpoint.private_ip == "10.16.0.6"
